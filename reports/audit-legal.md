# Audit Legal Report
**Generated:** 2026-05-18T20:58:17.039Z
...
| `legal.email.privacy` | ✅ | /privacy/ uses canonical email from PUBLIC_FACT_LEDGER §1 | email mia@miasanabria.com present |
...
| `legal.email.terms` | ✅ | /terms/ uses canonical email from PUBLIC_FACT_LEDGER §1 | email mia@miasanabria.com present |
...
| `legal.email.accessibility` | ✅ | /accessibility/ uses canonical email from PUBLIC_FACT_LEDGER §1 | email mia@miasanabria.com present |
...
| `legal.email.dmca` | ✅ | /dmca/ uses canonical email from PUBLIC_FACT_LEDGER §1 | email mia@miasanabria.com present |
