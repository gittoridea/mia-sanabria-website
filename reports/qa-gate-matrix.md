...
Base: `https://miasanabriarealtor.trueidea.com`  ·  Generated: 2026-05-11T04:35:03.210Z

**40 routes scanned** · severity → critical 0 · high 4 · medium 1 · low 40

**Owner-category split** → c1 site:0 · c2 tool:0 · c3 principal:0 · c4 GHL:1 · c5 legal:4 · c6 launch:40
...
| Route | H1 | Title (len) | Meta (len) | Schemas | Links | Trust | FAQ | Form | Stale clean | Mobile | Findings |
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/about` | ✓ | 60 | 152 | 7 | 44 | ✓ | ✓ | — | ✓ | ✓ | l:noindex(c6) |
...
| Route | H1 | Title (len) | Meta (len) | Schemas | Links | Trust | FAQ | Form | Stale clean | Mobile | Findings |
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/buyers` | ✓ | 52 | 159 | 8 | 49 | ✓ | ✓ | — | ✓ | ✓ | l:noindex(c6) |
| `/sellers` | ✓ | 58 | 152 | 8 | 49 | ✓ | ✓ | — | ✓ | ✓ | l:noindex(c6) |
| `/valuation` | ✓ | 49 | 141 | 7 | 46 | ✓ | ✓ | mailto | ✓ | ✓ | l:noindex(c6) |

## markets_index (1 routes)

| Route | H1 | Title (len) | Meta (len) | Schemas | Links | Trust | FAQ | Form | Stale clean | Mobile | Findings |
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/markets` | ✓ | 51 | 157 | 4 | 60 | ✓ | — | — | ✓ | ✓ | l:noindex(c6) |
