...
Base: `https://miasanabriarealtor.trueidea.com`  ·  Generated: 2026-05-11T20:22:11.799Z
...
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/` | ✓ | 56 | 154 | 6 | 68 | ✓ | ✓ | — | ✓ | ✓ | l:noindex(c6) |

## other (4 routes)

| Route | H1 | Title (len) | Meta (len) | Schemas | Links | Trust | FAQ | Form | Stale clean | Mobile | Findings |
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/404` | ✓ | 39 | 132 | 2 | 41 | ✓ | — | — | ✓ | — | l:noindex(c6) |
| `/downloads/fort-lauderdale-waterfront-valuation-prep-sheet` | ✓ | 62 | 97 | 2 | 39 | ✓ | — | — | ✓ | — | l:noindex(c6) |
| `/downloads/luxury-seller-pre-listing-checklist` | ✓ | 50 | 85 | 2 | 39 | ✓ | — | — | ✓ | — | l:noindex(c6) |
| `/downloads/waterfront-buyer-due-diligence-checklist` | ✓ | 55 | 90 | 2 | 39 | ✓ | — | — | ✓ | — | l:noindex(c6) |
...
| Route | H1 | Title (len) | Meta (len) | Schemas | Links | Trust | FAQ | Form | Stale clean | Mobile | Findings |
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/accessibility` | ✓ | 38 | 131 | 4 | 39 | ✓ | — | — | ✓ | — | h:legal_review(c5) l:noindex(c6) |
| `/dmca` | ✓ | 26 | 117 | 4 | 39 | ✓ | — | — | ✓ | — | h:legal_review(c5) l:noindex(c6) |
| `/privacy` | ✓ | 29 | 141 | 4 | 39 | ✓ | — | — | ✓ | — | h:legal_review(c5) l:noindex(c6) |
| `/terms` | ✓ | 31 | 136 | 4 | 40 | ✓ | — | — | ✓ | — | h:legal_review(c5) l:noindex(c6) |
...
| Route | H1 | Title (len) | Meta (len) | Schemas | Links | Trust | FAQ | Form | Stale clean | Mobile | Findings |
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/insights` | ✓ | 55 | 152 | 4 | 65 | ✓ | — | — | ✓ | ✓ | l:noindex(c6) |

## insight_post (12 routes)

| Route | H1 | Title (len) | Meta (len) | Schemas | Links | Trust | FAQ | Form | Stale clean | Mobile | Findings |
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/insights/bay-colony-and-bermuda-riviera-private-waterfront` | ✓ | 59 | 143 | 5 | 54 | ✓ | ✓ | — | ✓ | — | l:noindex(c6) |
| `/insights/boca-raton-luxury-buyers-club-beach-waterfront` | ✓ | 48 | 147 | 5 | 52 | ✓ | ✓ | — | ✓ | — | l:noindex(c6) |
...
| `/markets/victoria-park` | ✓ | 47 | 155 | 6 | 57 | ✓ | ✓ | — | ✓ | — | l:noindex(c6) |

## thank_you (4 routes)

| Route | H1 | Title (len) | Meta (len) | Schemas | Links | Trust | FAQ | Form | Stale clean | Mobile | Findings |
|-------|----|--------------|------------|---------|-------|-------|-----|------|-------------|--------|----------|
| `/thank-you` | ✓ | 24 | 138 | 3 | 41 | ✓ | — | — | ✓ | — | l:noindex(c6) |
| `/thank-you/buyer-brief` | ✓ | 35 | 123 | 3 | 41 | ✓ | — | — | ✓ | — | l:noindex(c6) |
| `/thank-you/market-brief` | ✓ | 44 | 119 | 3 | 41 | ✓ | — | — | ✓ | — | l:noindex(c6) |
| `/thank-you/valuation` | ✓ | 41 | 139 | 3 | 41 | ✓ | — | — | ✓ | — | l:noindex(c6) |

## Owner-category legend

1 site/content/design  ·  2 tool/process  ·  3 principal decision  ·  4 GHL/ops  ·  5 legal/compliance  ·  6 launch/cutover