...
**Generated:** 2026-05-10T21:11:51.849Z
**Mode:** local
...
|---|:-:|---|---|
| `rendered.images.allRendered` | ✅ PASS | Every non-lazy image renders with naturalWidth>0, renderedWidth>0, opacity>0 | 0 broken images across 135 probes |

### Market Index

| ID | Status | Description | Evidence |
|---|:-:|---|---|
| `rendered.marketCards.allVisibleOnIndex` | ✅ PASS | /markets/ index renders ≥10 market cards with imgVisible=true | 15 visible cards (best viewport: 320x568) |
...
| ID | Status | Description | Evidence |
|---|:-:|---|---|
| `rendered.hero.headingFitsPanel` | ✅ PASS | Hero heading stays inside the copy panel (no right-edge clipping) | 0 offenders across 135 probes |
| `rendered.hero.eyebrowFitsPanel` | ✅ PASS | Hero eyebrow stays inside the copy panel (no right-edge clipping) | 0 offenders across 135 probes |
| `rendered.hero.subFitsPanel` | ✅ PASS | Hero sub-paragraph stays inside the copy panel (no right-edge clipping) | 0 offenders across 135 probes |
...
| ID | Status | Description | Evidence |
|---|:-:|---|---|
| `rendered.mobile.noHorizontalOverflow` | ✅ PASS | No horizontal overflow at mobile viewports (≤768) — viewport-honest probes only | 0 overflow at 27 viewport-honest probes; 54 dishonest probes SKIPPED (instrumentation mismatch) |
...
| `rendered.probe.viewportSanity` | ⚠️ WARN | Every probe's actual window.innerWidth matches requested viewport width (±5px) — F6 instrumentation gate | 81/135 probes viewport-honest; 54 mismatched (chrome --dump-dom clamps mobile to ~500px — screenshot channel + GPT-5.5 visual review covers the gap) |
...
**Evidence:** 81/135 probes viewport-honest; 54 mismatched (chrome --dump-dom clamps mobile to ~500px — screenshot channel + GPT-5.5 visual review covers the gap)
